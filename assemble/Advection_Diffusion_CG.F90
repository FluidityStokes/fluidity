...
contains
  ...
  subroutine assemble_advection_diffusion_cg(t, matrix, rhs, state, dt, velocity_name, &
    ...
    do i = 1, ele_count(t)
      call assemble_advection_diffusion_element_cg(i, t, matrix, rhs, &
                                        ...
                                        heatcap, reftemp, supg_element)
    end do

    ! as part of assembly include the already discretised optional source
    ! needed before applying dirichlet boundary conditions
  ...
  subroutine assemble_advection_diffusion_element_cg(ele, t, matrix, rhs, &
    ...
    ! Mass
    if(have_mass) call add_mass_element_cg(ele, test_function, t, density, olddensity, heatcap, detwei, detwei_old, detwei_new, matrix_addto, rhs_addto)
  ...
  subroutine add_mass_element_cg(ele, test_function, t, density, olddensity, heatcap, detwei, detwei_old, detwei_new, matrix_addto, rhs_addto)
    integer, intent(in) :: ele
