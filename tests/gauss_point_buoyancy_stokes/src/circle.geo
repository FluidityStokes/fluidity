...
Transfinite Line{3} = lti+1 Using Bump pt;
Transfinite Line{7} = lti+1 Using Bump pt;
Transfinite Line{11} = lti+1 Using Bump pt;
Transfinite Line{15} = lti+1 Using Bump pt;
Transfinite Line{19} = lti+1 Using Bump pt;
Transfinite Line{23} = lti+1 Using Bump pt;
Transfinite Line{27} = lti+1 Using Bump pt;
Transfinite Line{31} = lti+1 Using Bump pt;
Transfinite Line{4} = lto+1 Using Bump pt;
Transfinite Line{8} = lto+1 Using Bump pt;
Transfinite Line{12} = lto+1 Using Bump pt;
Transfinite Line{16} = lto+1 Using Bump pt;
Transfinite Line{20} = lto+1 Using Bump pt;
Transfinite Line{24} = lto+1 Using Bump pt;
Transfinite Line{28} = lto+1 Using Bump pt;
Transfinite Line{32} = lto+1 Using Bump pt;
