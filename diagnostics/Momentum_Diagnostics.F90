...
module momentum_diagnostics
  ...
  use state_module
  use Momentum_Diagnostic_Fields, only: quantify_rotational_velocity
  ...
  public :: calculate_strain_rate, calculate_bulk_viscosity, calculate_sediment_concentration_dependent_viscosity, &
            ...
            calculate_geostrophic_velocity, calculate_k_epsilon_diffusivity, calculate_rotational_velocity
...
contains
  ...
  subroutine calculate_rotational_velocity(state, v_field)
    ...
    ewrite(1,*) 'In calculate_rotational_velocity diagnostic'         

    call quantify_rotational_velocity(state, v_field)
